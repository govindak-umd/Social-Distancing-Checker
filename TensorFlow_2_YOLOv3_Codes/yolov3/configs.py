...
TRAIN_CLASSES               = "./Text_Files/people_all_names.txt"
TRAIN_ANNOT_PATH            = "./Text_Files/people_train.txt"
TRAIN_LOGDIR                = "./log"
TRAIN_CHECKPOINTS_FOLDER    = "checkpoints"
TRAIN_MODEL_NAME            = "yolov3_custom_combined_dataset"
...
TRAIN_LR_END                = 1e-6#1e-6
TRAIN_WARMUP_EPOCHS         = 2
TRAIN_EPOCHS                = 10 #100

# TEST options
TEST_ANNOT_PATH             = "./Text_Files/people_test.txt"
TEST_BATCH_SIZE             = 4
TEST_INPUT_SIZE             = 416
TEST_DATA_AUG               = False

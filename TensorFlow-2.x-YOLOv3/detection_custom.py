...
time_s = time.time()
video_path = ["Test_Video/people_walking.mp4"]
...
# 	count+=1
for v in video_path:
	detect_video(yolo, v, "./IMAGES/new_image_"+str(count)+".mp4", input_size=input_size, show=False, CLASSES=TRAIN_CLASSES, rectangle_colors=(255,0,0))
	count+=1
time_end = time.time()
